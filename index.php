...
// Leer animación festiva activa desde admin_config
$animacionActiva = 'ninguna';
$_animRes = @$conn->query("SELECT valor FROM admin_config WHERE clave = 'animacion_festiva' LIMIT 1");
if ($_animRes && $_animRow = $_animRes->fetch_assoc()) {
    $animacionActiva = $_animRow['valor'] ?: 'ninguna';
}
...
<?php require_once __DIR__ . '/includes/animacion_festiva.php'; ?>
</body>
